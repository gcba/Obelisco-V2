export const SMType1 = `<div className="status status-info">
...
export const SMType2 = `<div className="status status-success">
  <h2 className="status-title">
...
export const SMType3 = `<div className="status status-warning">
  <h2 className="status-title">
...
export const SMType4 = `<div className="status status-danger">
  <h2 className="status-title">
...
export const SMType5 = `<div className="status status-institutional">
  <h2 className="status-title">
