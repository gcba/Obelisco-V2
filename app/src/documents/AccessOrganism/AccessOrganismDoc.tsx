...
import {
  CATEGORIES_ACCESS_ORGANISM,
  LIST_ACCESS_ORGANISM,
  SIMPLE_ACCESS_ORGANISM,
} from './code-views';
                      ...
                      <div className="group-access">
                        <div className="card-access">
                          <div className="card-access-body reverse">
                            ...
                            <span className="card-access-icon material-symbols-rounded" aria-hidden="true">info</span>
                          </div>
