...
export const organismsPages = [
  ...
  { text: 'Cabecera de página multimedia', url: '/components/', id: 4 },
...
export const componentsPages = [
  ...
  { text: 'Destacado lateral', url: '/components/highlighted-lateral', id: 13 },
  { text: 'Enlace', url: '/components/link', id: 14 },
  { text: 'Etiquetas', url: '/components/badge', id: 15 },
  { text: 'Galería', url: '/components/gallery', id: 16 },
  { text: 'Lista de enlaces', url: '/components/list-link', id: 17 },
  { text: 'Lista de pasos', url: '/components/list-step', id: 18 },
  { text: 'Lista informativa', url: '/components/list-informative', id: 19 },
  { text: 'Mapa', url: '/components/map', id: 20 },
  { text: 'Mensaje de estado', url: '/components/status-message', id: 21 },
  { text: 'Migas de pan', url: '/components/breadcrumb', id: 22 },
  { text: 'Modal', url: '/components/modal', id: 23 },
  { text: 'Navegación horizontal', url: '/components/nav-horizontal', id: 24 },
  { text: 'Navegación vertical', url: '/components/nav-vertical', id: 25 },
  { text: 'Paginado', url: '/components/pagination', id: 26 },
  { text: 'Pestañas', url: '/components/tabs', id: 27 },
