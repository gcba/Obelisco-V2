...
export const TEMPLATE_TRAMITES = `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
...
export const TEMPLATE_PAG_SIMPLE = `<!DOCTYPE html>
<html lang="es">
...
export const TEMPLATE_PAG_LIBRO = `<!DOCTYPE html>
<html lang="es">
  ...
  <main id="main">
    <article class="pb-5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-xl-4">
            <div class="nav-container mb-5 mb-md-0">
              <nav aria-label="Navegación vertical">
                <ul class="nav flex-column nav-pills">
                  <li class="nav-item">
                    <a class="nav-link active" href="#"><span>Adultos y Adolescentes</span></a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#"><span>Supervisiones y sedes</span></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#"><span>Ventanilla Única de Adultos (VUA)</span></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#"><span>Contacto</span></a>
                  </li><li class="nav-item">
                    <a class="nav-link" href="#"><span>Buscá tu escuela</span></a>
                  </li>
                </ul>
              </nav>
            </div>
          ...
          <div class="col-12 col-xl-8">
            <div>
              <h1 class="mb-3">Adultos y Adolescentes</h1>
              <p class="lead">El área de Educación de Adultos y Adolescentes ofrece una variada oferta educativa para personas mayores de 14 o de 18 años. Además, de los espacios de educación formal (primaria y secundaria para adultos -CENS presencial, Adultos 2000 a distancia, Plan FINES-), el área brinda cursos que facilitan la inserción laboral.
              </p>
            </div>
            ...
            <section>
              <h2 class="mb-4">Educación Primaria para Adultos</h2>
              <p class="mb-4">Tiene como finalidad brindar la oportunidad de finalizar los estudios primarios a personas mayores de 14 años, a través de diferentes modalidades y programas:
              </p>
                <div class="list-link" >
                  <a href="#" target="_blank" rel="noopener noreferrer">Centros Educativos de Nivel primario (CENP)</a>
                  <a href="#" target="_blank" rel="noopener noreferrer">Programa de Alfabetización, Educación Básica y Trabajo - (PAEBYT)</a>
                  <a href="#" target="_blank" rel="noopener noreferrer">Listado supervisiones terminalidad primaria para adultos</a>
                </div>
                <a href="#" class="btn btn-primary mt-4 mb-5">Conocer más</a>
                
                <h2 class="mb-4">Educación Secundaria para Adultos</h2>
                <p class="mb-4">Tiene como finalidad brindar la oportunidad de retomar y finalizar los estudios secundarios a personas mayores de 18 años. Existen diferentes alternativas y modalidades:
                </p>
                <div class="list-link" >
                    <a href="#" target="_blank" rel="noopener noreferrer">Centros Educativos de Nivel Secundario (CENS, presencial)</a>
                    <a href="#" target="_blank" rel="noopener noreferrer">Adultos 2000 (A distancia)</a>
                    <a href="#" target="_blank" rel="noopener noreferrer">FINES (Plan de Finalización de Estudios Secundarios)</a>
                    <a href="#" target="_blank" rel="noopener noreferrer">UGEE - BACHIS</a>
                </div>
                <a href="#" class="btn btn-primary mt-4 mb-5">Conocer más</a>
...
export const TEMPLATE_PAG_NOTICIAS = `<!DOCTYPE html>
<html lang="es">
...
export const TEMPLATE_FORM = `<!DOCTYPE html>
<html lang="es">
...
export const TEMPLATE_FORM_MULTIPAGINA = `<!DOCTYPE html>
<html lang="es">
...
export const TEMPLATE_PERFIL_INSTITUCIONAL = `<!DOCTYPE html>
<html lang="es">
              ...
              <article class="d-flex flex-column flex-md-row gap-5">
                ...
                <div class="col d-flex flex-column justify-content-between">
                  ...
                  <section id="contacto">
                    ...
                    <p class="mb-0" style="color: #38485C"><i>Última actualización: <time
            ...
            <section class="accordion">
              ...
              <div class="accordion-item item-white">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapseMisionesFunciones" aria-expanded="false"
                  aria-controls="collapseMisionesFunciones">
                  <span class="collapse-title">Objetivos</span>
                </button>
                <div id="collapseMisionesFunciones" class="accordion-collapse collapse">
                  <div class="accordion-body">
                    <p>Este espacio describe la misión del área y las funciones que cumple dentro de su rol
                      institucional,
              ...
              <div class="accordion-item item-white">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  <span class="collapse-title">Responsabilidades primarias</span>
                </button>
