...
<header class="o-header navbar" role="banner">
    ...
    <div class="container header-container">
        <a href="https://buenosaires.gob.ar" class="navbar-brand">
          <img class="d-none d-xl-block" src="/Obelisco-V2/images/BA.svg" alt="Gobierno de la Ciudad de Buenos Aires - Inicio" />
          <img class="d-xl-none" src="/Obelisco-V2/images/ba_mobile.svg" alt="Gobierno de la Ciudad de Buenos Aires - Inicio" />
        </a>
