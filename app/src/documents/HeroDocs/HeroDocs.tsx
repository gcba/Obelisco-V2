              ...
              <div className="hero-container">
                <div className="hero-box-sizing ">
                  <header className="hero bg-content-hero-light">
                    {/* HEADER */}
                    <header
                      className="o-header navbar position-absolute top-0 start-0 z-3 w-100 bg-glass"
                      role="banner"
                    >
                      <LinkClient href="#main" className="skip-to-main-content-link">
                        Saltar al contenido principal
              ...
              <div className="hero-container">
                <div className="hero-box-sizing">
                  <header className="hero">
                    {/* HEADER */}
                    <header className="o-header tecba-navbar navbar w-100" role="banner">
                      <LinkClient href="#main" className="skip-to-main-content-link">
                        Saltar al contenido principal
                      </LinkClient>
                      <div className="container header-container">
        ...
        <>
          <CodeBox codeHTML={HERO_DINAMICO}>
            <div className="container">
              <div className="hero-container">
                <div className="hero-box-sizing">
                  <header className="hero hero-radius">
                    {/* HEADER */}
                    <header
