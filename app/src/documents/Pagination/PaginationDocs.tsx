          ...
          <div className="row justify-content-center mt-4">
            <div className="col-auto">
              <div className="btn-group" role="group" aria-label="Basic example">
                ...
                <button type="button" className={`btn ${selectedExample === 'central' ? 'btn-primary' : 'btn-secondary'}`} onClick={() => setSelectedExample('central')}>Central</button>
                <button type="button" className={`btn ${selectedExample === 'final' ? 'btn-primary' : 'btn-secondary'}`} onClick={() => setSelectedExample('final')}>Final</button>
              </div>
            </div>
          </div>
