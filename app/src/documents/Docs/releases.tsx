...
const ReleasesComponents: React.FC = () => {
  ...
  const sections = [
    {
      title: 'Versión 1.19.0',
      content: (
        <ul className="docs-list">
          <p>La Versión 1.19.0 contiene lo siguiente: </p>
          ...
          <li>
            Se crearon las clases <code>indicator-items-3</code> y <code>indicator-items-2</code> para la disposición de
            Indicadores.
          </li>
