...
import { INPUT_BLOCK, INPUT_DATE, INPUT_DISABLED, INPUT_MAIL, INPUT_NUMBER, INPUT_TEXT, INPUT_VALIDATION_DATE, INPUT_VALIDATION_MAIL, INPUT_VALIDATION_TEXT, INPUT_VALIDATION_TEXTAREA } from './code-views';
