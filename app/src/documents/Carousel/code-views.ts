...
export const CAROUSEL_DESTACADO_DARK = `
	<div id="carousel-dark" class="carousel dark slide" data-bs-wrap="false">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<div class="panel-horizontal-content">
					<div class="panel-horizontal">
...
export const CAROUSEL_CARDS = `
	<div id="carousel-cards" class="carousel cards slide" data-bs-wrap="false">
...
export const CAROUSEL_CARDS_DARK = `
	<div id="carousel-cards-dark" class="carousel cards dark slide" data-bs-wrap="false">
		<h4 class="m-0">Encabezado de la seccion</h4>
