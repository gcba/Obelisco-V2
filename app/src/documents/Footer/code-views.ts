...
export const FOOTER_LEGALS = `<h2 class="sr-only">Navegación de pie de página</h2>
<footer class="main-footer">
  <div class="container">
    <section class="footer-legal-section">
      <h3 class="sr-only">Información gubernamental</h3>
...
export const FOOTER_INDICATOR = `<h2 class="sr-only">Navegación de pie de página</h2>
