...
const sections = [
  {
    ...
    content: (
      <MainDescription description="Esta nueva versión es una evolución de la versión anterior, 'Obelisco V1', y busca mejorar y actualizar los componentes y estilos ofrecidos,
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mt-3">Obelisco V2 se distingue de su predecesor por varias mejoras clave que optimizan tanto la funcionalidad proporcionada por Bootstrap 5 como el rendimiento general del sistema. En esta nueva versión, hemos implementado una serie de actualizaciones y refinamientos para ofrecer una experiencia de usuario superior y una integración más eficiente. A continuación, se detallan algunas de las principales mejoras que diferencian a Obelisco V2 de Obelisco V1: </p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <li><strong>Incorporación de Nuevas Clases</strong>: Se han añadido nuevas clases, adaptadas a las nuevas funcionalidades y estilos de Bootstrap 5.</li>
    ),
  },
  {
    id: 'section-6',
