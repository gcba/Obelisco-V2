...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <CodeBox codeHTML={SMType1}> {/* Asegúrate de agregar el cierre de la etiqueta */}
  ...
  },
  {
    ...
    content: (
      <>
        <CodeBox codeHTML={SMType2}> {/* Asegúrate de agregar el cierre de la etiqueta */}
          <div className="container p-3 bg-light">
  ...
  },
  {
    ...
    content: (
      <>
        <CodeBox codeHTML={SMType3}> {/* Asegúrate de agregar el cierre de la etiqueta */}
          <div className="container p-3 bg-light">
  ...
  },
  {
    ...
    content: (
      <>
        <CodeBox codeHTML={SMType4}> {/* Asegúrate de agregar el cierre de la etiqueta */}
          <div className="container p-3 bg-light">
  ...
  },
  {
    ...
    content: (
      <>
        <CodeBox codeHTML={SMType5}> {/* Asegúrate de agregar el cierre de la etiqueta */}
          <div className="container p-3 bg-light">
