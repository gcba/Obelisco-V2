        ...
        <>
          <div className="container">
            ...
            <div className="container">
              ...
              <div className="max-items-2 mt-4 mb-2">
                <div className="col">
                  <p className="text-xl">Botón claro <i>(light)</i></p>
                  <p className="text-md">Se usa para garantizar la visibilidad y legibilidad de las acciones en las interfaces con fondos oscuros.</p>
                </div>
                <div className="col">
                  <Image
              ...
              <div className="max-items-1 mt-4">
                ...
                <p className="text-md">Se utiliza dentro de la celda de una <a href="https://gcba.github.io/Obelisco-V2/components/table">Tabla</a>, economizando el espacio disponible. No cuenta con relleno ni borde. </p>
                <Image
            ...
            <div className="py-4">
              <div className="max-items-2">
                ...
                <div className="col">
                  ...
                  <div className="d-flex pt-3">
                    <span className="material-symbols-rounded text-success">check</span>
                    <p className="mb-0 text-wrap w-100">Respetar el uso de mayúsculas al comienzo de la etiqueta.
                    </p>
                  </div>
                </div>
                {/* 6 */}
