...
export const componentsPages = [
  ...
  { text: 'Mapa', url: '/components/map', id: 21 },
  { text: 'Mensaje de estado', url: '/components/status-message', id: 2 },
  { text: 'Migas de pan', url: '/components/breadcrumb', id: 23 },
  { text: 'Modal', url: '/components/modal', id: 24 },
  { text: 'Navegación horizontal', url: '/components/nav-horizontal', id: 25 },
  { text: 'Navegación vertical', url: '/components/nav-vertical', id: 26 },
  { text: 'Paginado', url: '/components/pagination', id: 27 },
  { text: 'Pestañas', url: '/components/tabs', id: 28 },
  { text: 'Spinner', url: '/components/spinner', id: 29 },
  { text: 'Switch', url: '/components/switch', id: 30 },
  { text: 'Tarjetas', url: '/components/cards', id: 31 },
  { text: 'Tooltip', url: '/components/tooltip', id: 32 },
];
