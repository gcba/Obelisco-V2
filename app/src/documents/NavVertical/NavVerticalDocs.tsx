...
import { EGcodeNavVertical1, EGcodeNavVertical2, EGcodeNavVertical3, EGcodeNavVertical4, EGcodeNavVertical5, EGcodeNavVertical6, EGcodeImportNavVertical } from './code-views';
              ...
              <article className="box-content col-12 col-lg-8">
                <div data-cy="section-wrapper">
                  ...
                  <section id="section-2" ref={section2Ref}>
                    ...
                    <CodeCopy code={EGcodeImportNavVertical} />
                  </section>
                  ...
                  <section id="section-4" ref={section4Ref}>
                    ...
                    <br />
                    <CodeCopy code={EGcodeNavVertical1} />
                  </section>
                  ...
                  <section id="section-6" ref={section6Ref}>
                    ...
                    <CodeCopy code={EGcodeNavVertical4} />
                  </section>
                  ...
                  <section id="section-7" ref={section7Ref}>
                    ...
                    <CodeCopy code={EGcodeNavVertical5} />
                  </section>
                  ...
                  <section id="section-8" ref={section8Ref}>
                    ...
                    <CodeCopy code={EGcodeNavVertical2} />
                  </section>
                  ...
                  <section id="section-9" ref={section9Ref}>
                    ...
                    <CodeCopy code={EGcodeNavVertical3} />
                  </section>
                  ...
                  <section id="section-10" ref={section10Ref}>
                    ...
                    <CodeCopy code={EGcodeNavVertical6} />
                  </section>
                </div>
              </article>
            </div>
