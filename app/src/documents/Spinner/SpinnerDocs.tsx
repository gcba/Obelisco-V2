...
const SpinnerDocs: React.FC = () => {
  const SECTION_UX = [
      ...
      content: (
        <>
          ...
          <div className="list-informative pb-3" style={{ marginTop: '32px' }}>
            ...
            <ul className="list-informative-bullet">
              <li>
                Para indicar el progreso de una acción en curso con un tiempo definido predecible, utilizar la{' '}
                <a href="https://gcba.github.io/Obelisco-V2/components/progress-bar">Barra de progreso</a>.
              </li>
              <li>Para acciones inmediatas, como enviar un formulario.</li>
            </ul>
          </div>
        </>
      ),
      ...
      content: (
        <>
          <p className="text-md mb-4">
            Existen distintas variantes de color para el <i>spinner,</i> cada uno con un significado semántico asociado,
            y no meramente decorativo, que permiten mantener coherencia con el contexto de uso, como estados de carga,
            éxito o error. En fondos claros, se recomienda utilizar el <i>spinner</i> primario como opción
            predeterminada.
          </p>
      ...
      content: (
        <>
          ...
          <div className="list-informative pt-4">
            <ul className="list-informative-bullet">
              <li>
                <strong>Chico:</strong> se utiliza en elementos puntuales, como botones o <i>inputs</i> con carga.
              </li>
              <li>
                <strong>Mediano:</strong> es ideal para modales o secciones de la interfaz.
              </li>
              <li>
                <strong>Grande:</strong> se utiliza para pantallas completas o procesos de carga generales.
              </li>
            </ul>
          </div>
        </>
      ...
      content: (
        <>
          <p className="text-md mb-4">
            ...
            de <i>spinner</i> correspondiente con la de cada botón.
          </p>
    ...
    {
      subtitle: <>Como única referencia visual</>,
      content: (
        <>
          <p className="text-md">
            Una acción particular puede desencadenar la carga de todo el contenido de una página. En este caso, debe
            utilizarse el <i>spinner</i> grande centrado, para identificar el procesamiento de la acción. Además, debe
            ir acompañando de una etiqueta descriptiva que sirva de contexto sobre el contenido a cargar.
          </p>
          <p className="text-md">
          ...
          <div className="col">
            ...
            <div className="d-flex pt-2">
              ...
              <p className="mb-0">
                No utilizar el <i>spinner</i> para la carga de contenidos multimedia como imágenes o videos. Tampoco
                utilizar más de 1 <i>spinner</i> a la vez.
              </p>
            </div>
          </div>
        </>
            ...
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  <td>Etiqueta</td>
                  <td>
                    Opcional, disponible solo para la variante de <strong>spinner grande</strong> cuando se requiera la
                    carga del contenido dela página.
                  </td>
                </tr>
              </tbody>
            </table>
  ...
  const ACCESSIBILITY = [
    {
      ...
      content: (
        <>
          <p className="text-md">
            Al ser un elemento que irrumpe en la navegación de la persona usuaria, que solo aparece para indicar la
            carga de un proceso y/o contenido, el <i>spinner</i> no debe ser recorrido ni operado por teclado para
            evitar confusiones al navegar por medios alternativos, como lectores de pantalla.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          <p className="text-md mb-4">
            ...
            y que la interfaz está en un proceso de carga, por lo que deberá esperar y no podrá continuar navegando
            hasta que finalice.
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-md">
            Para indicar a la persona usuaria, que utiliza medios alternativos para recorrer una página, sobre la
