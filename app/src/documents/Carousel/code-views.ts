...
export const CAROUSEL_CARDS = `<div id="carousel-cards-eventos" class="carousel cards slide">
			<div class="title">
...
export const CAROUSEL_CARDS_EVENTS = `<div id="carousel-cards-eventos" class="carousel cards bg-light slide">
			<div class="title">
				<h4 class="m-0">Encabezado de la seccion</h4>
				<a href="#" target="_blank" rel="noopener noreferrer">Enlace predeterminado</a>
			</div>
...
export const CAROUSEL_CARDS_DARK = `<div id="carousel-cards-eventos" class="carousel cards bg-dark slide">
			<div class="title">
				<h4 class="m-0">Encabezado de la seccion</h4>
				<a href="#" target="_blank" rel="noopener noreferrer">Enlace predeterminado</a>
			</div>
...
export const CAROUSEL_CARDS_IMPACTO_VISUAL = `<div id="carousel-cards-bg" class="carousel cards controls-top slide">
        <div class="title">
            <h4 class="m-0">Encabezado de la seccion</h4>
        ...
        <div class="carousel-indicators">
            <button
                ...
                aria-label="Slide 1"
            ></button>
            <button type="button" data-bs-target="#carousel-cards-bg" data-bs-slide-to="1" aria-label="Slide 2"></button>
            <button type="button" data-bs-target="#carousel-cards-bg" data-bs-slide-to="2" aria-label="Slide 3"></button>
        </div>
