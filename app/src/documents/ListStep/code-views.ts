...
`;
export const LIST_STEP_MEDIUM_NUMBER = `
<ul class="list-steps list-steps-numbers">
  <li class="list-steps-item">
    <h3 class="list-steps-item-title">Instrucción 1</h3>
    <p>
    En esta descripción de la instrucción 1 se muestran los detalles
...
`;
export const LIST_STEP_MEDIUM_NUMBER_BORDER = `
<ul class="list-steps list-steps-numbers list-steps-light">
  <li class="list-steps-item">
    <h3 class="list-steps-item-title">Instrucción 1</h3>
    <p>
    En esta descripción de la instrucción 1 se muestran los detalles
