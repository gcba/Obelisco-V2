...
export const HEADLINE = `
  <p class="headline-lg">Titular L - Archivo, 20px, IL 24px</p>
  <p class="headline-md">Titular M - Archivo, 18px, IL 24px</p>
  <p class="headline-sm">Titular S - Archivo, 16px, IL 20px</p>
`;
export const BODY = `
